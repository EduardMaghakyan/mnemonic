...
Download the latest `Mnemonic_0.1.0_aarch64.dmg` from the [GitHub releases](#) page (Apple Silicon only — Intel Macs are not a v1 target). Drag `Mnemonic.app` to `/Applications`.
